...
public class Items
{
    ...
    public static final Item NIKOLITE_INGOT = new ItemBase("nikolite_ingot");
    ...
    public static final Item RUTILE_INGOT = new ItemBase("rutile_ingot");
    ...
    public static final Item TENNANTITE_INGOT = new ItemBase("tennantite_ingot");
